namespace StneApi
{
    ...
    /// </summary>
    public class CHtmlDictionary : CTable
    {
        public String ExtensionCssClass;
        ...
        public CTableRow AddSeperator(Object Value, String Css) { return null; }
        public CHtmlDictionary(Object Titel) { }
        public CHtmlDictionary() { }
        public CHtmlDictionary(Object Key, Object Value) { }
        public CHtmlDictionary(IDictionary<Object, Object> Dic) { }
    }
}
