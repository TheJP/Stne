namespace StneApi
{
    ...
    /// </summary>
    public class CIntegerList : CCollectionBase<Integer>
    {
        public Integer this[Integer Index] { get { return null; } set { } }
        public Integer Add(Integer Value) { return null; }
        public Boolean Contains(Integer Value) { return null; }
        public void ConvertToStrings() { }
        public static CIntegerList CreateFromString(String Expression, String Seperator) { return null; }
